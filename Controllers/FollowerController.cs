...
namespace SessionProject2W5.Controllers
{
	public class FollowerController : Controller
	{
		...
		public IActionResult Search()
		{
			...
			search.BackgroundSrc = search.Criteria.GamesFilters.Count(f => f.Allowed == true) == 1 ? $"/images/games/{Database.Games.Single(g => g.Name == search.Criteria.GamesFilters.Single(f => f.Allowed == true).Name).ShortName}/artwork.webp" : "/images/shared/misc/defaultartwork.webp";
		...
		public IActionResult Search(SearchCriteriaViewModel criteria)
		{
			if (!ModelState.IsValid)
			{
				SearchViewModel invalidsearch = new SearchViewModel
				{
					Criteria = criteria,
					Results = Database.Followers,
					BackgroundSrc = criteria.GamesFilters.Count(f => f.Allowed == true) == 1 ? $"/images/games/{Database.Games.Single(g => g.Name == criteria.GamesFilters.Single(f => f.Allowed == true).Name).ShortName}/artwork.webp" : "/images/shared/misc/defaultartwork.webp"
				};
		...
		public IActionResult Search(string name)
		{
			...
			search.BackgroundSrc = criteria.GamesFilters.Count(f => f.Allowed == true) == 1 ? $"/images/games/{Database.Games.Single(g => g.Name == criteria.GamesFilters.Single(f => f.Allowed == true).Name).ShortName}/artwork.webp" : "/images/shared/misc/defaultartwork.webp";
