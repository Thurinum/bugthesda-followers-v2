...
let ITEMS = $$(""); // ADD CSS SELECTOR OF POPUP TRIGGERS HERE (E.G. ".carteEnfant")
let CHANCE = 0.35;  // % CHANCE FOR POPUP DISPLAY (1 = 100%)
...
<marquee bgcolor=#222 scrolldelay=10 truespeed><font color=red>█ █ █ █ █ █ █ █</font></marquee>
<button class="collabBtn link" data-href=https://420-2w5-2176651-thewitcher.azurewebsites.net/ ><b>ACCÉDER AU SITE</b></button>
</section>`;
...
document.body.style.transition.style.opacity = "0";
document.body.style.transition = "opacity 0.5s ease-out";

window.addEventListener("load", function () {
	document.body.style.transition.style.opacity = "1";
	registerLinks();
});