...
childImage.addEventListener("mouseover", function (e: any) {
    e.target.style.objectFit = "none";
});
childImage.addEventListener("mousemove", function (e: any) {
...
childImage.addEventListener("mouseleave", function (e: any) {
